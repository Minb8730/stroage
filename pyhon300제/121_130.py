...
# >> a
# A
# 힌트-1 : islower() 함수는 문자의 소문자 여부를 판별합니다. 만약 소문자일 경우 True, 
# 대문자일 경우 False를 반환합니다. 힌트-2 : upper() 함수는 대문자로, lower() 함수는 소문자로 변경합니다.
...
whole = { "011" : "SKT", "016" : "KT", "019" : "LGU", "010" : "알수없음"}
...
address = input("우편번호 5자리 입력 > ")
address = address[2]
if address in [0, 1, 2]:
    print("강북구")
elif address in [3, 4, 5]:
    print("도봉구")
else:
    print("노원구")
