...
def printmxn(string, num1):
    str_devine = int(len(string) / num1) 
    for i in range(str_devine + 1):
        print(string[i * num1 : i * num1 + num1])
...
def clac_monthly_salary(annual_salary):
    print(int(annual_salary/12))

clac_monthly_salary(120000000)
