...
my_list = ["가", "나", "다", "라"]
for k in range(3):
    print(my_list[int(k)], my_list[1+int(k)])
...
my_list = ["가", "나", "다", "라", "마"]
for k in range(3):
    print(my_list[int(k)], my_list[1+int(k)], my_list[2+int(k)])
...
my_list = ["가", "나", "다", "라"]
for k in range(3):
    print(my_list[-k - 1], my_list[int(-k-2)])
...
my_list = [100, 200, 400, 800]
for b in range(len(my_list)-1):
    print(my_list[b+1] - my_list[b])
...
my_list = [100, 200, 400, 800, 1000, 1300]
for h in range(len(my_list)-2):
    print((my_list[h] + my_list[h+1] + my_list[h+2])/3) 
