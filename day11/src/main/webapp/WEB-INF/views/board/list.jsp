...
<!-- protocol://serverName:serverPort/path?varName=varValue&varName2=varValue2
				 -->
	...
	<div class="sb">
		<div>
			<form>
				<input type="hidden" name="page" value="1">  <!-- 4 페이지에서 검색을 할 경우 제대로 작동하지 않기 때문에 검색 후 첫번째 페이지로 이동시켜준다. -->
				<select name="type">
